...
IDO 5.3 with the `ido53_o2` profile exactly reproduces 1,001 reviewed functions
totaling 228,308 bytes in the canonical USA image. Current regional reports

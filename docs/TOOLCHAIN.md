...
IDO 5.3 with the `ido53_o2` profile exactly reproduces 1,004 reviewed functions
totaling 229,224 bytes in the canonical USA image. Current regional reports

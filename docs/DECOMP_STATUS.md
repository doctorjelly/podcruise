...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,000 | 227,880 | 36.66% | 1,213 | 1,000 |
...
not yet match. The USA manifest currently covers 1,249 functions and 419,664
original bytes in reviewed C, or 67.52% of CPU text; only the exact 36.66% is
eligible for substitution in the canonical rebuild.

The strict manifest audit currently finds 54 source files without matching
units; 52 still need either a unit or a recorded exception. Those sources are

...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,040 | 243,140 | 39.12% | 1,306 | 1,040 |
| Japan retail | 893 | 196,460 | 31.61% | 956 | 884 |
| Europe retail | 894 | 204,584 | 32.92% | 955 | 885 |
| USA LRG revision | 1,040 | 243,140 | 39.12% | 1,304 | 1,011 |
...
not yet match. The USA manifest currently covers 1,348 functions and 616,976
original bytes in reviewed C, or 99.27% of CPU text; only the exact 39.12% is

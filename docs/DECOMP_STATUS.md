...
|---|---:|---:|---:|---:|---:|
| USA retail | 994 | 226,736 | 36.48% | 1,204 | 993 |
...
not yet match. The USA manifest currently covers 1,241 functions and 416,864
original bytes in reviewed C, or 67.07% of CPU text; only the exact 36.48% is

...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,300 | 1,008 |
...
not yet match. The USA manifest currently covers 1,337 functions and 555,008
original bytes in reviewed C, or 89.30% of CPU text; only the exact 37.00% is

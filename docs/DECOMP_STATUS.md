...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,003 | 229,216 | 36.88% | 1,278 | 1,003 |
...
not yet match. The USA manifest currently covers 1,314 functions and 514,144
original bytes in reviewed C, or 82.72% of CPU text; only the exact 36.88% is

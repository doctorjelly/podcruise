...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,005 | 229,248 | 36.88% | 1,284 | 1,005 |
...
not yet match. The USA manifest currently covers 1,320 functions and 516,352
original bytes in reviewed C, or 83.08% of CPU text; only the exact 36.88% is

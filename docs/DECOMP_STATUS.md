...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,006 | 229,404 | 36.91% | 1,286 | 1,006 |
...
not yet match. The USA manifest currently covers 1,322 functions and 516,664
original bytes in reviewed C, or 83.13% of CPU text; only the exact 36.91% is

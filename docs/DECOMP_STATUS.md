...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,012 | 230,744 | 37.12% | 1,306 | 1,012 |
...
not yet match. The USA manifest currently covers 1,343 functions and 587,732
original bytes in reviewed C, or 94.56% of CPU text; only the exact 37.12% is

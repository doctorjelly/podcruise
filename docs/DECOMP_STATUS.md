...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,287 | 1,008 |
...
not yet match. The USA manifest currently covers 1,324 functions and 517,248
original bytes in reviewed C, or 83.22% of CPU text; only the exact 37.00% is

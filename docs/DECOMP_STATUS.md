...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,293 | 1,008 |
...
not yet match. The USA manifest currently covers 1,330 functions and 529,712
original bytes in reviewed C, or 85.23% of CPU text; only the exact 37.00% is

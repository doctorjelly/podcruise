...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,003 | 229,216 | 36.88% | 1,281 | 1,003 |
...
not yet match. The USA manifest currently covers 1,317 functions and 516,016
original bytes in reviewed C, or 83.02% of CPU text; only the exact 36.88% is

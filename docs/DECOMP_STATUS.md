...
|---|---:|---:|---:|---:|
| USA retail | 918 | 192,172 | 30.92% | 1,140 |
| Japan retail | 837 | 168,392 | 27.09% | 904 |
| Europe retail | 837 | 175,712 | 28.27% | 903 |
| USA LRG revision | 918 | 192,172 | 30.92% | 1,140 |
...
match. The USA ledger currently represents 317,296 original bytes in reviewed
C, or 51.05% of CPU text; only the exact 30.92% is eligible for substitution

...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,000 | 227,880 | 36.66% | 1,211 | 999 |
...
not yet match. The USA manifest currently covers 1,248 functions and 418,252
original bytes in reviewed C, or 67.29% of CPU text; only the exact 36.66% is

...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,002 | 228,856 | 36.82% | 1,277 | 1,002 |
...
not yet match. The USA manifest currently covers 1,313 functions and 513,784
original bytes in reviewed C, or 82.66% of CPU text; only the exact 36.82% is

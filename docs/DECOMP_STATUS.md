...
|---|---:|---:|---:|---:|---:|
| USA retail | 993 | 226,680 | 36.47% | 1,203 | 992 |
...
not yet match. The USA manifest currently covers 1,240 functions and 416,808
original bytes in reviewed C, or 67.06% of CPU text; only the exact 36.47% is

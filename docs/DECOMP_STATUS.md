...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,292 | 1,008 |
...
not yet match. The USA manifest currently covers 1,329 functions and 527,144
original bytes in reviewed C, or 84.81% of CPU text; only the exact 37.00% is

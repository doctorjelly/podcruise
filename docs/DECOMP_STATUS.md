...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,012 | 230,744 | 37.12% | 1,309 | 1,012 |
...
not yet match. The USA manifest currently covers 1,346 functions and 606,732
original bytes in reviewed C, or 97.62% of CPU text; only the exact 37.12% is

...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,000 | 227,880 | 36.66% | 1,265 | 1,000 |
...
not yet match. The USA manifest currently covers 1,301 functions and 509,584
original bytes in reviewed C, or 81.99% of CPU text; only the exact 36.66% is

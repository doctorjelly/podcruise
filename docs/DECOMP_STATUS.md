...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,288 | 1,008 |
...
not yet match. The USA manifest currently covers 1,325 functions and 518,052
original bytes in reviewed C, or 83.35% of CPU text; only the exact 37.00% is

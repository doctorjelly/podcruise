...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,003 | 229,216 | 36.88% | 1,282 | 1,003 |
...
not yet match. The USA manifest currently covers 1,318 functions and 516,320
original bytes in reviewed C, or 83.07% of CPU text; only the exact 36.88% is

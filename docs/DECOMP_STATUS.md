...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,006 | 229,404 | 36.91% | 1,285 | 1,006 |
...
not yet match. The USA manifest currently covers 1,321 functions and 516,508
original bytes in reviewed C, or 83.10% of CPU text; only the exact 36.91% is

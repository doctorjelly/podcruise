...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,012 | 230,744 | 37.12% | 1,305 | 1,012 |
| Japan retail | 889 | 194,692 | 31.32% | 956 | 887 |
| Europe retail | 890 | 202,816 | 32.63% | 955 | 888 |
| USA LRG revision | 1,012 | 230,744 | 37.12% | 1,304 | 991 |
...
not yet match. The USA manifest currently covers 1,342 functions and 582,488
original bytes in reviewed C, or 93.72% of CPU text; only the exact 37.12% is

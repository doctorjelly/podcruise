...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,289 | 1,008 |
| Japan retail | 888 | 194,404 | 31.28% | 956 | 887 |
| Europe retail | 889 | 202,528 | 32.58% | 955 | 888 |
| USA LRG revision | 993 | 226,680 | 36.47% | 1,203 | 991 |
...
not yet match. The USA manifest currently covers 1,326 functions and 520,176
original bytes in reviewed C, or 83.69% of CPU text; only the exact 37.00% is

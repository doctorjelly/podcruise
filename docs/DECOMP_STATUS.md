...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,295 | 1,008 |
...
not yet match. The USA manifest currently covers 1,332 functions and 533,528
original bytes in reviewed C, or 85.84% of CPU text; only the exact 37.00% is

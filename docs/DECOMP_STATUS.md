...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,301 | 1,008 |
...
not yet match. The USA manifest currently covers 1,338 functions and 560,736
original bytes in reviewed C, or 90.22% of CPU text; only the exact 37.00% is

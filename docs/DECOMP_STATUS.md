...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,000 | 227,880 | 36.66% | 1,228 | 1,000 |
...
not yet match. The USA manifest currently covers 1,264 functions and 441,008
original bytes in reviewed C, or 70.95% of CPU text; only the exact 36.66% is
eligible for substitution in the canonical rebuild.

The strict manifest audit currently finds 39 source files without matching
units; 37 still need either a unit or a recorded exception. Those sources are

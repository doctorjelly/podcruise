...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,001 | 228,308 | 36.73% | 1,275 | 1,001 |
...
not yet match. The USA manifest currently covers 1,311 functions and 512,632
original bytes in reviewed C, or 82.48% of CPU text; only the exact 36.73% is

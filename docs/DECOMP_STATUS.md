...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,294 | 1,008 |
...
not yet match. The USA manifest currently covers 1,331 functions and 530,544
original bytes in reviewed C, or 85.36% of CPU text; only the exact 37.00% is

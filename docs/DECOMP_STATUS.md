...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,012 | 230,744 | 37.12% | 1,304 | 1,012 |
...
not yet match. The USA manifest currently covers 1,341 functions and 576,808
original bytes in reviewed C, or 92.80% of CPU text; only the exact 37.12% is

...
|---|---:|---:|---:|---:|---:|
| USA retail | 999 | 227,836 | 36.66% | 1,209 | 998 |
...
not yet match. The USA manifest currently covers 1,246 functions and 418,052
original bytes in reviewed C, or 67.26% of CPU text; only the exact 36.66% is

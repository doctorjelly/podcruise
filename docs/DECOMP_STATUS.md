...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,299 | 1,008 |
...
not yet match. The USA manifest currently covers 1,336 functions and 550,300
original bytes in reviewed C, or 88.54% of CPU text; only the exact 37.00% is

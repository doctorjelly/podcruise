...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,000 | 227,880 | 36.66% | 1,253 | 1,000 |
...
not yet match. The USA manifest currently covers 1,289 functions and 480,008
original bytes in reviewed C, or 77.23% of CPU text; only the exact 36.66% is
eligible for substitution in the canonical rebuild.

The strict manifest audit currently finds 14 source files without matching
units; 12 still need either a unit or a recorded exception. Those sources are

...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,012 | 230,744 | 37.12% | 1,307 | 1,012 |
...
not yet match. The USA manifest currently covers 1,344 functions and 593,796
original bytes in reviewed C, or 95.54% of CPU text; only the exact 37.12% is

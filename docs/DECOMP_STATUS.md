...
|---|---:|---:|---:|---:|
| USA retail | 918 | 192,172 | 30.92% | 1,129 |
| Japan retail | 837 | 168,392 | 27.09% | 893 |
| Europe retail | 837 | 175,712 | 28.27% | 892 |
| USA LRG revision | 918 | 192,172 | 30.92% | 1,129 |
...
match. The USA ledger currently represents 308,756 original bytes in reviewed
C, or 49.68% of CPU text; only the exact 30.92% is eligible for substitution

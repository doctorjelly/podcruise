...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,297 | 1,008 |
...
not yet match. The USA manifest currently covers 1,334 functions and 541,104
original bytes in reviewed C, or 87.06% of CPU text; only the exact 37.00% is

...
|---|---:|---:|---:|---:|
| USA retail | 918 | 192,172 | 30.92% | 1,134 |
| Japan retail | 837 | 168,392 | 27.09% | 898 |
| Europe retail | 837 | 175,712 | 28.27% | 897 |
| USA LRG revision | 918 | 192,172 | 30.92% | 1,134 |
...
match. The USA ledger currently represents 312,240 original bytes in reviewed
C, or 50.24% of CPU text; only the exact 30.92% is eligible for substitution

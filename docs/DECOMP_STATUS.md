...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,000 | 227,880 | 36.66% | 1,248 | 1,000 |
...
not yet match. The USA manifest currently covers 1,284 functions and 470,592
original bytes in reviewed C, or 75.71% of CPU text; only the exact 36.66% is
eligible for substitution in the canonical rebuild.

The strict manifest audit currently finds 19 source files without matching
units; 17 still need either a unit or a recorded exception. Those sources are

...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,298 | 1,008 |
...
not yet match. The USA manifest currently covers 1,335 functions and 545,664
original bytes in reviewed C, or 87.79% of CPU text; only the exact 37.00% is

...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,012 | 230,744 | 37.12% | 1,308 | 1,012 |
...
not yet match. The USA manifest currently covers 1,345 functions and 601,472
original bytes in reviewed C, or 96.77% of CPU text; only the exact 37.12% is

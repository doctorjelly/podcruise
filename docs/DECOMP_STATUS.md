...
|---|---:|---:|---:|---:|---:|
| USA retail | 998 | 227,380 | 36.58% | 1,208 | 997 |
...
not yet match. The USA manifest currently covers 1,245 functions and 417,596
original bytes in reviewed C, or 67.19% of CPU text; only the exact 36.58% is

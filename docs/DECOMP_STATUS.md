...
|---|---:|---:|---:|---:|---:|
| USA retail | 997 | 227,128 | 36.54% | 1,206 | 996 |
...
not yet match. The USA manifest currently covers 1,243 functions and 417,172
original bytes in reviewed C, or 67.12% of CPU text; only the exact 36.54% is

...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,302 | 1,008 |
...
not yet match. The USA manifest currently covers 1,339 functions and 566,056
original bytes in reviewed C, or 91.07% of CPU text; only the exact 37.00% is

...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,000 | 227,880 | 36.66% | 1,224 | 1,000 |
...
not yet match. The USA manifest currently covers 1,260 functions and 433,464
original bytes in reviewed C, or 69.74% of CPU text; only the exact 36.66% is
eligible for substitution in the canonical rebuild.

The strict manifest audit currently finds 43 source files without matching
units; 41 still need either a unit or a recorded exception. Those sources are

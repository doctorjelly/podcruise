...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,012 | 230,744 | 37.12% | 1,310 | 1,012 |
...
not yet match. The USA manifest currently covers 1,347 functions and 611,612
original bytes in reviewed C, or 98.40% of CPU text; only the exact 37.12% is

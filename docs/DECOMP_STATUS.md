...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,000 | 227,880 | 36.66% | 1,243 | 1,000 |
...
not yet match. The USA manifest currently covers 1,279 functions and 462,060
original bytes in reviewed C, or 74.34% of CPU text; only the exact 36.66% is
eligible for substitution in the canonical rebuild.

The strict manifest audit currently finds 24 source files without matching
units; 22 still need either a unit or a recorded exception. Those sources are

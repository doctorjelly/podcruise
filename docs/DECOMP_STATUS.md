...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,008 | 229,988 | 37.00% | 1,291 | 1,008 |
...
not yet match. The USA manifest currently covers 1,328 functions and 524,564
original bytes in reviewed C, or 84.40% of CPU text; only the exact 37.00% is

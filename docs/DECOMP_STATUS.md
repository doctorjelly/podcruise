...
|---|---:|---:|---:|---:|---:|
| USA retail | 1,010 | 230,344 | 37.06% | 1,303 | 1,010 |
...
not yet match. The USA manifest currently covers 1,340 functions and 570,920
original bytes in reviewed C, or 91.86% of CPU text; only the exact 37.06% is

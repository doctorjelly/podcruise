...
- 1,341 functions represented by independently written C, covering 576,808
  ...
  unmeasured.
- Exact IDO 5.3 matches for 1,012 of them (230,744 bytes) in the canonical USA
  image. The current regional reports contain 889 matches (194,692 bytes) for
  Japan, 890 (202,816 bytes) for Europe, and 1,012 (230,744 bytes) for the later

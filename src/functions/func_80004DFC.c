/* Recovered from specification specs/func_80004DFC.md */
...
extern void func_800049FC(Object *obj, s32 arg1, s32 arg2);

void func_80004DFC(Object *obj, s32 arg1, s32 arg2) {
    s32 count;
    s32 type;
    u8 buffer[0x40];
    Object *child;

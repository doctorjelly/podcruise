...
void func_800511B0(Owner800511B0 *owner, s32 mode) {
    ...
    if (mode != 0) {
        if (D_800A2198 != -1) {
            func_8001535C(&delta, &D_80118DE0.unkF0, &D_80118DE0.unk30);
            func_800155EC(&D_80118DE0.unkF0, &D_80118DE0.unkF0, 10.0f, &delta);
        }
        func_80015630(&D_80118DE0.unk30, 0.3333f, &D_80118DE0.unk30, 0.6667f,
                      &D_80118DE0.unkF0);
        if (owner->unk34 == 1) {
            func_80015288(&D_80118DE0.unk30, &D_800A5148);
            pick = func_80051934();
            r = (f32)func_80082BE0() / (f32)2147483648.0;
            D_80118DE0.unk30.x += (180.0f + 10.0f * r) * pick;
            r = (f32)func_80082BE0() / (f32)2147483648.0;
            D_80118DE0.unk30.y += D_800AB364 + 125.0f * r;
            r = (f32)func_80082BE0() / (f32)2147483648.0;
            D_80118DE0.unk30.z = r * 30.0f + 40.0f;
            func_80015288(&D_80118DE0.unkF0, &D_800A5148);
            func_8001535C(&step, &D_80118ED0, &D_80118DE0.unk30);
            func_80015328(&D_80118DE0.unkF0, &D_80118DE0.unkF0, &step);
        }
    } else {
        func_80015288(&D_80118DE0.unkF0, &D_800A4C00[owner->unk34].unk0C);
        func_80015288(&D_80118DE0.unk30, &D_800A4C00[owner->unk34].unk00);
    }
    D_800A4BC0 = 1;
    D_800A4BD0 = 1;
}

...
void func_80052A08(Screen *screen, s32 request) {
    ...
    if ((screen->unk008 & 0x20) || (screen->unk008 & 0x40)) {
        ...
        top = 8;
        bottom = 232;
        func_800862D8(1, 8, (s32)(top + shrink), 312, (s32)(bottom - shrink));
    ...
    switch (screen->unk1E0) {
        ...
        case 2:
            ...
            bottom = 232;
            func_800862D8(1, 8, (s32)(top + shrink), 312, (s32)(bottom - shrink));
            func_800862D8(0, 8, (s32)(top + shrink), 312, (s32)(bottom - shrink));
        ...
        case 5:
            ...
            if (players == 1 || players == 0) {
                ...
                top = 8;
                right = 312;
                func_800862D8(1, 8, 8, (s32)(right - shrink), 119);
                func_800862D8(2, (s32)(top + shrink), 121, 312, 232);
                if (D_800A52B8 != 0) {

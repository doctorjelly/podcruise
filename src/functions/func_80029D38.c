/* Independently written from specs/functions/recovered/func_80029D38.md. */
...
void func_80029D38(void *arg0) {
    ...
    func_80047A78(arg0, 0xFF, base + 0x30,
                  (f32)(u32)D_80113E84[row] * D_800A9E10, (f32)av, 7.0f, 26.0f);

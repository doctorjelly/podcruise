...
void func_80062EC8(Obj80062EC8 *object, s32 arg1, s32 arg2, s32 arg3) {
    if (object != 0) {
        ...
        object->unk30 = arg1;
        object->unk34 = arg2;
        func_80015268(object->unk44, 0.0f, 0.0f, 0.0f);
        func_80015268(object->unk50, 0.0f, 0.0f, 0.0f);
        func_80015268(object->unk5C, 0.0f, 0.0f, 0.0f);
        object->unk88 = -1;
        object->unk14 = 0;
        object->unk10 = 0.0f;
        object->unk08 = arg3;
        ...
        func_80015268(object->unk20, 0.0f, 0.0f, 0.0f);
        object->unk2C = 0.0f;
